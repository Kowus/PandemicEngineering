...
#define OXYGEN_CHART_MIN_VALUE
#define OXYGEN_CHART_MAX_VALUE
#define OXYGEN_CHART_MAX_POINTS 100
#define OXYGEN_CHART_REFRESH_TIME 150
#define OXYGEN_CHART_LINE_MODE 1
#define OXYGEN_CHART_DOT_SIZE 5
#define OXYGEN_CHART_LINE_WIDTH 2
