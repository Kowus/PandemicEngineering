    ...
    : Screen()
{
    ...
    charts[CHART_IDX_OXYGEN] = SensorChart(
        "Oxygen Concentration ",
        OXYGEN_CHART_MIN_VALUE,
        OXYGEN_CHART_MAX_VALUE,
        OXYGEN_CHART_MAX_POINTS,
        OXYGEN_CHART_REFRESH_TIME,
        true,
        OXYGEN_CHART_DOT_SIZE,
        OXYGEN_CHART_LINE_WIDTH);
}
